...
class MLTrainingPipeline:
    ...
    def collect_training_data(self, days: int = 7):
        ...
        classification_path = "data/datasets/raw/collected_classifications.jsonl"
        challenge_path = "data/datasets/raw/collected_challenges.jsonl"
    ...
    def train_task_classifier(self):
        ...
        config = {
            ...
            "use_qlora": True,
            "train_dataset_path": "data/datasets/raw/task_classification.jsonl",
            "output_dir": "models/task_classifier",
    ...
    def train_challenge_generator(self):
        ...
        config = {
            ...
            "base_model": self.config.get("base_model", "mistralai/Mistral-7B-v0.1"),
            "use_qlora": True,
            "train_dataset_path": "data/datasets/raw/challenge_generation.jsonl",
            "output_dir": "models/challenge_generator",
            **self.config.get("training_config", {})
        }
...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/ml_training_config.json")
