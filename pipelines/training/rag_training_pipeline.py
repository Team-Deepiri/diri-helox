...
# RAGPipeline is in cyrex/integrations (used by runtime)
# For training, import from cyrex or use a shared location
import sys
from pathlib import Path
# Add cyrex to path for RAGPipeline
cyrex_path = Path(__file__).parent.parent.parent.parent / "diri-cyrex" / "app"
sys.path.insert(0, str(cyrex_path))
from integrations.rag_pipeline import RAGPipeline
# Add helox to path for logging
