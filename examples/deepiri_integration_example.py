    ...
    try:
        ...
        execution_plan = {
            ...
            "estimated_total_duration": sum(
                t.get("estimate", {}).get("hours", 0) for t in generated_tasks
            ),
            "complexity": "medium",
        }
        ...
        return {"success": True, "tasks": generated_tasks, "execution_plan": execution_plan}
...
async def boost_activated_example(
    user_id: str, boost_type: str, boost_source: str, credits_used: int, duration_minutes: int
):
