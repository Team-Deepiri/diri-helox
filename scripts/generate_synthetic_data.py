...
class AbilityGenerator:
    """
    Minimal ability-data generator.
    This is a placeholder so you can generate ability datasets separately
    from classification datasets.
    """
    ...
    def generate(self, num_examples=50):
        ...
        print(f"✓ Ability dataset generated: {out_file}")
...
def generate_synthetic_dataset(
    ...
    """
    Added data_type argument so this script can support:
      - classification
      - ability
      - rl (future)
    """
...
if __name__ == "__main__":
    ...
    generate_synthetic_dataset(
        ...
        data_type=args.data_type,  # NEW: pass the mode to the generator
    )