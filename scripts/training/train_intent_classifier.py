...
def detect_device(force_cpu: bool = False) -> dict:
    ...
    Returns dict with keys:
      ...
      - reason (str)
    """
    info = {"device": "cpu", "use_gpu": False, "gpu_name": None, "capability": None, "reason": ""}
...
def train_intent_classifier(
    ...
    train_file: str = "data/datasets/raw/classification_train.jsonl",
    val_file: str = "data/datasets/raw/classification_val.jsonl",
    ...
    print(
        "  Core: writing, learning_research, learning_study, learning_training, learning_practice"
    )
    ...
    if not train_path.exists():
        ...
        print(
            "   Or: python scripts/pipelines/run_dynamic_pipeline.py --config configs/dynamic_pipeline_config.json"
        )
        return
    ...
    try:
        ...
        model = AutoModelForSequenceClassification.from_pretrained(
            model_name, num_labels=num_abilities
        )
    except Exception as e:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="bert-base-uncased", help="Base model to fine-tune")
    parser.add_argument(
        "--train-file",
        default="data/datasets/raw/classification_train.jsonl",
        help="Training data file",
    )
    parser.add_argument(
        "--val-file",
        default="data/datasets/raw/classification_val.jsonl",
        help="Validation data file",
    )
    parser.add_argument(
        "--output-dir", default="models/intent_classifier", help="Output directory for model"
    )
    parser.add_argument(
        "--num-abilities", type=int, default=31, help="Number of task categories (default: 31)"
    )
    parser.add_argument(
