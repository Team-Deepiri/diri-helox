...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-file", default="data/datasets/raw/classification_train.jsonl",
                       help="Training data file")
    parser.add_argument("--val-file", default="data/datasets/raw/classification_val.jsonl",
                       help="Validation data file")
    parser.add_argument("--output-dir", default="models/intent_classifier",
