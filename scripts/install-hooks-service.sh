...
echo "   - Main repository: Protected (main, dev (exact), master, branches containing 'team-dev')"
echo "   - All submodules: Protected (main, dev (exact), master, branches containing 'team-dev')"
echo ""
echo "📝 Next steps:"
